...
def Arg():
    ...
    arg_parser.add_argument('--sampler', action='store_true', help='use sampler to solve imbalance problem')
...
def main():
    ...
    if args.train != None:
        ...
        Train(model, train_dataloader, dev_dataloader, dev_index_list, criterion, optimizer, device, args.model_name, args.dev_ref_file, epochs=args.epochs)
